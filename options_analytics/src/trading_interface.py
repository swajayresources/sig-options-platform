    ...
    def _render_template(self, template_name: str, **kwargs) -> str:
        ...
        <head>
            ...
            <style>
                ...
                .table-dark {{ background-color: #2d2d2d; }}
                .alert-success {{ background-color: #155724; border-color: #28a745; color: #d4edda; }}
                .alert-danger {{ background-color: #721c24; border-color: #dc3545; color: #f8d7da; }}
